...
from palmetto_data import df_from_address, calculate_costs, generate_heater_params, generate_cooling_params, compare_monthly_costs
...
class ConsumptionRequest(BaseModel):
    ...
    HVAC_info: Optional[List[HVACRecord]] = HVACRecord(variable='heating', start_time=12, duration=3, setpoint=20)
...
async def get_consumption(request: ConsumptionRequest):
    ...
    compared_costs = compare_monthly_costs(monthly_forecast_before.set_index("from_datetime")["cost"],
